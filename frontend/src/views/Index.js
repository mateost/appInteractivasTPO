...
import info2 from "assets/img/component-info-2.png";
import menu from "assets/img/component-menu.png";
import btnPink from "assets/img/component-btn-pink.png";
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              <h2 className="font-semibold text-4xl text-blueGray-600">
                Tarket - A beautiful extension for Tailwind CSS.
              </h2>
