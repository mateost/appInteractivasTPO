...
import teamImg1 from "assets/img/team-1-800x800.jpg";
import teamImg2 from "assets/img/team-2-800x800.jpg";
import teamImg3 from "assets/img/team-3-800x800.jpg";
import teamImg4 from "assets/img/team-4-470x470.png";
          ...
          <table className="items-center w-full bg-transparent border-collapse">
            ...
            <tbody>
              <tr>
                ...
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <i className="fas fa-circle text-orange-500 mr-2"></i> Inscripción
                </td>
                <td className="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4">
                  <div className="flex">
                    <img
