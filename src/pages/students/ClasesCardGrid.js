...
const TabControl = styled.div`
  ${tw`cursor-pointer px-6 py-3 mt-1 sm:mt-0 sm:mr-2 last:mr-0 text-gray-600 font-medium rounded-md transition duration-300 text-sm sm:text-base w-1/2 sm:w-auto text-center`}
  &:hover {
...
const CardImageContainer = styled.div`
  ${props => css`background-image: url("${props.imageSrc}"); height:10rem !important;`}
